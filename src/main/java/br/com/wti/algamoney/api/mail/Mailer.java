package br.com.wti.algamoney.api.mail;
...
/**
 * @author Washington Antunes for wTI on 10/08/2023
 */
@Component
public class Mailer {
    ...
    public void avisarSobreLancamentosVencidos(List<Lancamento> vencidos, List<Usuario> destinatarios) {
        ...
        this.enviarEmail("washington_join@hotmail.com",
                emails,
    ...
    private void enviarEmail(String remetente, List<String> destinatarios, String assunto, String template, Map<String, Object> variaveis) {
        ...
        // melhoria para o codigo variaveis.entrySet().forEach(e -> context.setVariable(e.getKey(), e.getValue()));
